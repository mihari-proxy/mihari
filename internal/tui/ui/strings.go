...
const (
	...
	ExportLabel                  = "Export"
	ExportNowLabel               = "Current Time"
	ExportRangeLabel             = "Range"
	ExportSourcesLabel           = "Sources"
	ExportSourcesMachineAndUser  = "Machine and current user"
	ExportSourcesCurrentUserOnly = "Current user only"
	ExportMachineUnavailable     = "Machine logs are unavailable. Choose Current user only."
	ExportFromLabel              = "From"
	ExportToLabel                = "To"
	ExportOutputLabel            = "Output path"
	ExportRange24Hours           = "Last 24 hours"
	ExportRange60Minutes         = "Last 60 minutes"
	ExportRangeBetween           = "Between"
	ExportRangeAll               = "All"
	...
	ExportFailed                 = "Could not export logs"
	ExportTimeInvalid            = "Use YYYY-MM-DD HH:MM for From and To"
	ExportRangeInvalid           = "From must not be after To"
	ExportBusy                   = "An export is already running"
	ExportSuccessHelp            = "Enter copy path  Esc close"
	ExportFormHelp               = "↑/↓ fields  Enter edit  Esc cancel"
...
const (
	...
	MihariChannelLabel      = "Mihari channel"
	...
	LoggingMachineDirectoryLabel = "Machine logs"
	LoggingUserDirectoryLabel    = "Current user logs"
	LoggingExportDirectoryLabel  = "Default export"
	LocalFileLogUnavailable      = "Local file log unavailable"
	LoggingMaxSizeInvalid        = "Max file size must be an integer from 1 to 100 MiB"
	LoggingMaxFilesInvalid       = "Files to keep must be an integer from 1 to 10"
	LoggingProgressApplying      = "Applying"
	LoggingProgressReloading     = "Reloading"
	LoggingUpdateFailed          = "Could not update logging settings"
	LoggingReloadFailed          = "Could not reload logging settings"
	...
	MihariProgressPreparing     = "Preparing"
	...
	UpdateMihariRollback            = "Preparation can be cancelled. After confirmation this TUI closes; reopen Mihari to retry if installation fails."
	UpdateMihariUpToDate            = "Up to date"
	UpdateMihariAvailable           = "available"
	UpdateMihariAhead               = "ahead of %s %s"
	UpdateMihariCheckFailed         = "Mihari version check failed"
	UpdateMihariActionFailed        = "Mihari update failed"
	MihariChannelFailed             = "Mihari channel failed"
...
const (
	...
	SetupPortAutoFixHint            = "A port was in use. Switched to an available port; press Enter again to continue."
	...
	SetupReviewCoreLocal            = "Already available"
	SetupReviewCoreFresh            = "Newly installed"
	SetupReviewCoreFailed           = "Installation failed"
	SetupReviewSubscriptionNone     = "Not added (skipped)"
