...
const (
	...
	ServiceInstallImpact       = "Registers Mihari as a native OS service (Windows Service / systemd / launchd) that runs the daemon."
	ServiceUninstallImpact     = "Removes the OS service registration. The running daemon may stop and the TUI control connection can disconnect."
	ServiceReinstallImpact     = "Stops and removes the current OS service, then registers and starts this mihari binary. Use after upgrading to refresh ImagePath."
