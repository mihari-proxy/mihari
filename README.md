...
The current foundation slice provides an authenticated local daemon control API over a Windows named pipe or Unix domain socket. It does not bind a TCP control port.
...
Mihomo supervision, subscriptions, TUI, and Web panels remain planned work and are not part of this foundation slice yet.
