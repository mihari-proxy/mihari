...
> **2026-09-09 状态更新：** 本文关于完整 RootConfigPolicy、字段白名单及新建受管 provider 资源图的要求已由[移除方案](../plans/2026-09-09-remove-root-config-policy.md)替代；TUN 仅覆盖 enable。Unix 布局、核心身份校验、安装事务与历史 WAL 恢复约束继续保留。下文保留原设计及审核时的历史内容。
