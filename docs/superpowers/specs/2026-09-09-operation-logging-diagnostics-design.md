...
后续策略替代：日志脱敏摘要、取消静默、预期拒绝 DEBUG 及旧长度上限由[2026-09-14 完整错误日志设计](2026-09-14-full-error-logging-design.md)替代；内部 cause 与公开错误分离、实际 owner 去重、协议与生命周期边界继续适用。本文保留原阶段审计背景，新验证结果见对应模块登记。
